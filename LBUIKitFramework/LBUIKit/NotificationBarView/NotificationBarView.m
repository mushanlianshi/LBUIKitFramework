...
#define MYBUNDLE_NAME @ "BLTUIKitProject.bundle"
...
-(void)setContentViewStyle{
    ...
    // 添加渐变色()
    if (self.barStyle.gradientLayerOriginColor && self.barStyle.gradientLayerEndColor) {
...
//    CAGradientLayer *gradientLayer =  [CAGradientLayer layer];
    ...
    switch (self.barStyle.gradientDirection) {
        ...
        case GradientLayerDirectionTopToBottom:
        {
            //上下
            [self.gradientLayer setStartPoint:CGPointMake(0.0, 0.0)];
            [self.gradientLayer setEndPoint:CGPointMake(0.0, 1.0)];
        }
            break;
        case GradientLayerDirectionInclined:
        {
            //对角
            [self.gradientLayer setStartPoint:CGPointMake(0.0, 0.0)];
            [self.gradientLayer setEndPoint:CGPointMake(1.0, 1.0)];
        }
            break;
